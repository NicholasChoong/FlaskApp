...
class SystemTest(unittest.TestCase):
    ...
    def setUp(self):
        self.driver = webdriver.Firefox(
            executable_path=os.path.join(basedir, "geckodriver")
        )
        ...
        if not self.driver:
            ...
            db.create_all()
            s1 = Student(
                id="22222222", first_name="Test", surname="Case", cits3403=True
            )
            s2 = Student(
                id="11111111", first_name="Unit", surname="Test", cits3403=True
            )
    ...
    def test_register(self):
        ...
        self.assertEqual(
            logout.get_attribute("innerHTML"), "Logout Testy", msg="Logged in"
        )
